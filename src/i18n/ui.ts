...
const ru: Strings = {
  meta: {
    ...
    description:
      "Профессиональная аутоиммунная диагностика. нРИФ, иммуноблот, ИФА — полный спектр аутоиммунных исследований в одной лаборатории. Караганда, Астана, Алматы, Темиртау.",
  ...
  hero: {
    ...
    h1_lead: "Профессиональная",
    h1_accent: "аутоиммунная диагностика",
    h1_tail: "нРИФ, иммуноблот и ИФА в одной лаборатории",
    lede: "Полный спектр аутоиммунных исследований — от скрининга нРИФ до подтверждающих иммуноблотов и количественных ИФА-тестов. Срок 1-3 рабочих дня. Результаты — через защищённый портал.",
  ...
  tech: {
    ...
    imasa: {
      title: "нРИФ",
      tagline: "Непрямая иммунофлюоресценция — золотой стандарт скрининга",
      body:
  ...
  footer: {
    tagline: "Профессиональная аутоиммунная и аллергологическая диагностика. С 2017 года.",
...
const kk: Strings = {
  ...
  hero: {
    ...
    lede: "Аутоиммунды зерттеулердің толық спектрі — нРИФ скринингтен бастап растайтын иммуноблоттар мен сандық ИФА-тесттерге дейін. Мерзімі 1-3 жұмыс күні. Нәтижелер — қорғалған портал арқылы.",
  ...
  tech: {
    ...
    imasa: {
      title: "нРИФ",
      tagline: "Жанама иммунофлюоресценция — скринингтің алтын стандарты",
      body:
  ...
  footer: {
    tagline: "Кәсіби аутоиммунды және аллергологиялық диагностика. 2017 жылдан бері.",
