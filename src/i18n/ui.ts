...
const ru: Strings = {
  ...
  about_page: {
    title: "О лаборатории",
    lede:
      "IdeaLab — медицинская лаборатория, специализирующаяся на диагностике аутоиммунных заболеваний. Четыре филиала по Казахстану.",
...
const kk: Strings = {
  ...
  hero: {
    eyebrow: "Медициналық зертхана",
    h1_lead: "IdeaLab.kz",
    h1_accent: "Медициналық зертхана",
